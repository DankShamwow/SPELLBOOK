...
func _ready():
	...
	if amount > 1:
		status_description = str("Tiles are granted " + str(self.amount) + " additional points when used to attack.")
	elif amount == 1:
		status_description = str("Tiles are granted " + str(self.amount) + " additional point when used to attack.")
	elif amount == -1:
		status_description = str("Tiles are granted " + str(abs(self.amount)) + " less point when used to attack.")
	else:
		status_description = str("Tiles are granted " + str(abs(self.amount)) + " less points when used to attack.")
