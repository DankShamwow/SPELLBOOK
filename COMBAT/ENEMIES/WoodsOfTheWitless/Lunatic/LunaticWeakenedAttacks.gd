...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.B, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 2),
...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.W, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 6),
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.H, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 7),
...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.M, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 9),
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.P, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 10),
...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.D, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 13),
...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.M, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 16),
...
LetterTile.new().new_tile(LetterTile.TileType.STONED, LetterTile.TileLetter.Y, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, LetterTile.NotchTypes.EMPTY, 19),
