...
func _bringup_specialty_rewards(reward_notch_count: int = 0, reward_notch_uncommons: int = 0, reward_notch_rares: int = 0, reward_notch_specified: Array = [], allow_tiles: bool = false, draw_size: int = 0):
	...
	if not allow_tiles:
		...
		%NewTileBox.visible = false
	
	set_notch_reward_rng(reward_notch_count, reward_notch_uncommons, reward_notch_rares, reward_notch_specified, allow_tiles, draw_size)
	populate_notches_draws_and_tiles(notches, draws, tiles, allow_tiles)
...
func populate_notches_draws_and_tiles(notches: Array, draws: Array, tiles: Array, allow_tiles: bool = false):
...
func set_notch_reward_rng(notch_count: int, uncommon_count: int = 0, rare_count: int = 0, specified_rewards: Array = [], allow_tiles: bool = false, draw_size: int = 0):
