...
## The path to replace the player character to after it has been moved.
...
#region Shop-related things. There might be stuff that wants to fiddle with these values.

## How many consonants is a shop guaranteed to have?
var consonant_tile_stock: 				int = 2
## How many vowels is a shop guaranteed to have?
var vowel_tile_stock: 					int = 2
## How many unwieldy consonants is a shop guaranteed to have?
var unwieldy_tile_stock: 				int = 1
## How many blank tiles is a shop guaranteed to have?
var blank_tile_stock: 					int = 2
## How many notch packs of any variety is a shop guaranteed to have?
var any_notch_pack_stock: 				int = 2
## How many notch packs that are Uncommon or better is a shop guaranteed to have?
var uncommon_notch_pack_stock:			int = 1
## How many non-Shop specific Relics is a shop guaranteed to have?
var non_shop_relic_stock: 				int = 2
## How many Books? is a shop guaranteed to have?
var book_relic_stock: 					int = 1
## How many Shop specific Relics is a shop guaranteed to have?
var shop_relic_stock: 					int = 0

#endregion

#region Per-Run Data, consolidated here for ease of resetting.
...
var borrowed_relics_count:		int = 0

## library_size is the number of books that should be populated in a library.
## Starts at three, but can be increased over time.
var library_size:				int = 3
...
var played_words_dict: 			Dictionary[String, int] = {}
...
func prepare_word_dict(_file_path: Variant = null):
...
func _on_run_start():
	...
	currently_borrowed_relics.clear()
	played_words_dict.clear()
	borrowed_relics_count = 0
	scored_tile_count = 0
	played_words_count = 0
	chapter_combat_clear_count = 0
	chapter_boss_encounter = null
	combat_encounter = null
