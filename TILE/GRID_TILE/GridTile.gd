extends Control
## GridTile is a visual representation of a LetterTile, and is used wherever a player needs to interact with a tile.
class_name GridTile
...
## Is this GridTile one of the ghost tiles created in the player's tile rack?
var grid_ghost := false
## The GridTile that is paired with this tile.
var ghost_pair = null

## Lexical Notch Shenanigans
## The first potential GridTile generated by a Lexical Notch when this GridTile is added to a word.
var paired_tile_1 = null
## The second potential GridTile generated by a Lexical Notch when this GridTile is added to a word.
var paired_tile_2 = null
## The third potential GridTile generated by a Lexical Notch when this GridTile is added to a word.
...
func _ready():
	...
	if not self.tile.played_letter == self.tile.true_letter:
		%Tile_Letter.material.set_shader_parameter("is_warped", true)
	else:
		%Tile_Letter.material.set_shader_parameter("is_warped", false)
...
func _on_tile_button_gui_input(event: InputEvent):
	if event is InputEventMouseButton and event.pressed:
		if event.button_index == MOUSE_BUTTON_LEFT:
			#print("Left Clickety!")
			GameEventHandler.play_tile_sound.emit(self)
...
func spawned_from_bag():
	...
	scale_tween.tween_property(self, "scale", Vector2(0, 0), 0.000001)
	scale_tween.tween_property(self, "scale", Vector2(1, 1), 0.05)
...
func is_dying():
	...
	scale_tween.tween_property(self, "scale", Vector2(0, 0), 0.1)
...
func is_being_bagged():
	...
	scale_tween.tween_property(self, "scale", Vector2(0, 0), 0.05)
...
func is_vanishing():
	...
	scale_tween.tween_property(self, "scale", Vector2(0, 0), 0.15)

func is_being_added_to_deck():
	var tween = get_tree().create_tween()
	scale_tween = get_tree().create_tween()
	tween.tween_property(sprite, "modulate", Color(0, 0, 0, 0), 0.5)
	scale_tween.tween_property(self, "scale", Vector2(0, 0), 0.5)

func is_rapidly_shrinking():
	scale_tween = get_tree().create_tween()
...
func juice_score():
	...
	tween2.tween_property(%Tile_Mask, "modulate:a", 1, 0.1)
	scale_tween.tween_property(self, "scale", self.scale / 1.35, 0.01)
	tween2.tween_property(%Tile_Mask, "modulate:a", 0, 0.01)
